...
public class FuncionarioDTO {
    ...
    @NotNull(message = "O campo Numero CLT não pode ser nulo")
    @NotBlank(message = "O campo Numero CLT não pode ser vazio")
    ...
    public FuncionarioDTO(Funcionario obj) {
        ...
        this.data_contrato = obj.getData_contrato();
        this.num_clt = obj.getNum_clt();
        this.status = obj.getStatus();
        addPersonType(PersonType.FUNCIONARIO);
    }

    public FuncionarioDTO(UUID id, String nome, String rg, String cpf, String endereco, String end_num,
            String end_bairro, String end_cep, String email, String password, LocalDate createdAt,
            LocalDate data_contrato, String num_clt, Status status) {
        this.id = id;
        this.nome = nome;
        this.rg = rg;
        this.cpf = cpf;
